...
class PlanManagerGUI:
    ...
    def view_plan_details(self):
        ...
        # 标题
        ttk.Label(main_frame, text=plan_dict["title"], font=('Arial', 16, 'bold')).pack(anchor=tk.W, pady=(0, 10))
        ...
        priority_value = tk.Label(priority_frame, text=plan_dict["priority"].upper(), 
        ...
        if plan_dict["deadline"]:
            ttk.Label(left_frame, text=f"截止日期: {plan_dict['deadline']}", font=('Arial', 10)).pack(anchor=tk.W, pady=2)
        else:
            ttk.Label(left_frame, text="截止日期: 无", font=('Arial', 10)).pack(anchor=tk.W, pady=2)
            
        ttk.Label(left_frame, text=f"创建于: {plan_dict['created_at']}", font=('Arial', 10)).pack(anchor=tk.W, pady=2)
    ...
    def show_plan_dialog(self, plan_id=None):
        ...
        deadline_var = tk.StringVar(value=plan_dict["deadline"] if plan_dict and plan_dict["deadline"] else "")
        ...
        priority_var = tk.StringVar(value=plan_dict["priority"] if plan_dict else "medium")
        priority_frame = ttk.Frame(main_frame)
        ...
        tags_var = tk.StringVar(value=", ".join(plan_dict["tags"]) if plan_dict and plan_dict["tags"] else "")
